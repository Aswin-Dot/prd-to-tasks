...
export function InputPanel({
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="mb-6">
        <h3 className="text-xs font-semibold text-text-muted tracking-widest uppercase flex items-center gap-2 mb-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          {/* Team Size */}
          <div>
            <label className="block text-xs font-semibold text-text-muted tracking-wide mb-2">Team Size</label>
            <select
          ...
          {/* Sprint Length */}
          <div>
            <label className="block text-xs font-semibold text-text-muted tracking-wide mb-2">Sprint Length</label>
            <select
          ...
          {/* Tech Stack */}
          <div>
            <label className="block text-xs font-semibold text-text-muted tracking-wide mb-2">Tech Stack</label>
            <input
              type="text"
              value={context.stack || ''}
          ...
          {/* Platform */}
          <div>
            <label className="block text-xs font-semibold text-text-muted tracking-wide mb-2">Platform</label>
            <select
      ...
      <div className="flex-1 flex flex-col min-h-0">
        ...
        <textarea
          ...
          className="flex-1 w-full px-4 py-3 bg-bg-card border border-border rounded-xl text-text placeholder:text-text-dim focus:border-accent transition-all resize-none min-h-[300px] text-sm leading-relaxed"
        />
      </div>
      ...
      <div className="mt-5">
        {isGenerating ? (
          <button
            onClick={onCancel}
            className="w-full py-3 px-4 bg-red-500/10 border border-red-500/30 text-red-400 font-medium rounded-xl transition-all duration-200 flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full py-3 px-4 text-white font-semibold rounded-xl transition-all duration-200 flex items-center justify-center gap-2 btn-press glow-accent disabled:opacity-40 disabled:cursor-not-allowed disabled:shadow-none"
            style={{
